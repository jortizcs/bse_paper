...
a sensor is taking measurements. 
...
In addition, more descriptive information is sometimes unavailable to give detailed information
about the meaning of the tags -- so determining their meaning is painfully slow or impossible.  
Because these are conventions carried
about by humans, they are inconsistent within and across building data sets.
...
to disover the overlap to order for the search results to yield a higher harvest
