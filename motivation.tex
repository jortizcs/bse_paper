...
This means that analytical applications that use the data across a collection of buildings
need to make building-specific adjustments in order to run the same analysis job for each
...
To demonstrate this by collecting all the metadata across our building
...
of the setpoints in the building. 
